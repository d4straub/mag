...
## 5.4.3 Yellow Frog patch [2026-05-04]

### `Fixed`

- [#1032](https://github.com/nf-core/mag/pull/1032) - Fix hybrid co-assembly with SPAdes (short & long reads with `--coassemble_group`)
